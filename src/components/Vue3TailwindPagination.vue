<template>
  <div v-if="total_pages > 1" class="bg-white px-4 py-3 flex items-center justify-between sm:px-6">
    <!-- Pagination pour les écrans mobiles -->
    ...
    <!-- Pagination pour les écrans desktop -->
